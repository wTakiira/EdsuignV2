...
export default function FormInter() {
  ...
  return (
    <div className="flex-1 py-[var(--left-margin)] items-center flex flex-col px-[var(--big-space)] gap-[var(--big-space)]">
      <h1 className="h1 text-center">Formulaire de satisfaction</h1>
      <div className="flex items-center gap-[var(--big-space)]">
        <div className="p-2 bg-[var(--primary-bis)] rounded-[var(--custom-small-radius)]">
          <svg
        ...
        <CustomButton icon="share">Partager à tous</CustomButton>
      </div>
