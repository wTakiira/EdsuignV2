...
export default function ModuleInter() {
  ...
  return (
    <>
      <div className="flex-1 py-[var(--left-margin)] flex flex-col items-center gap-[var(--big-space)] px-[var(--big-space)]">
        <h1 className="h1 text-center">Module 2 : Framework CSS</h1>
        <div className="flex items-center gap-[var(--big-space)]">
          ...
          <CustomButton icon="file-text">Formulaire</CustomButton>
        </div>
